...
describe("dsp.delwrite~/delread~", function () {
  ...
  it("should take delay time as a signal to delread.i(0)", function (done) {
    ...
    helpers.expectSamples(
      ...
      [
        [0, 0, 0, 0, 2, 4, 6, 7, 8, 9],
        [
          (6 / Pd.getAudio().sampleRate) * 1000,
          (5 / Pd.getAudio().sampleRate) * 1000,
          (4 / Pd.getAudio().sampleRate) * 1000,
          (3 / Pd.getAudio().sampleRate) * 1000,
          (2 / Pd.getAudio().sampleRate) * 1000,
          (1 / Pd.getAudio().sampleRate) * 1000,
          0,
          0,
          0,
          0,
  ...
  describe("delread~.destroy", function () {
    it("should clean properly event handlers", function () {
      ...
      delread._delWrite.on("bla", function () {
        blaCalled++;
      });
