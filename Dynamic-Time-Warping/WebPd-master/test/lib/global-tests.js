...
describe("global", function () {
  ...
  describe("namedStore", function () {
    ...
    var MyNamedObject = function (name) {
      this.setName(name);
    };
    _.extend(
      MyNamedObject.prototype,
      mixins.NamedMixin,
    ...
    var MyUNamedObject1 = function (name) {
      this.setName(name);
    };
    _.extend(
      MyUNamedObject1.prototype,
      mixins.NamedMixin,
      EventEmitter.prototype,
      {
        nameIsUnique: true,
    ...
    var MyUNamedObject2 = function (name) {
      this.setName(name);
    };
    _.extend(
      MyUNamedObject2.prototype,
      mixins.NamedMixin,
      EventEmitter.prototype,
      {
        nameIsUnique: true,
    ...
    it("should unregister an object if it exists", function (done) {
      ...
      pdGlob.emitter.once(
        "namedObjects:unregistered:namedObj",
        function (anObj) {
