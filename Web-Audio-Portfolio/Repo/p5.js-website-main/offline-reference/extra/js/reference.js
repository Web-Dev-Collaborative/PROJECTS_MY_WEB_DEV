(function () {
  ...
  define("text!tpl/list.html", [], function () {
        ...
        if (items && listCollection) {
          ...
          _.each(items, function (item, i) {
            if (!item.private && item.file.indexOf("addons") === -1) {
              ...
              if (group === "Constants" && !item.example) return;
  ...
  define("text!tpl/itemEnd.html", [], function () {
  ...
  define("text!tpl/menu.html", [], function () {
  ...
  define("menuView", ["App", "text!tpl/menu.html"], function (App, menuTpl) {
