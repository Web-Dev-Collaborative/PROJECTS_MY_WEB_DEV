        ...
        return (
          ...
          (r.verify = function (t, r) {
            ...
            (a = t.replace(/\n\r?/g, "$split$").split("$split$")),
              ...
              (u = new Reporter(a, r)),
              (r.errors = 2);
            for (s in r) r.hasOwnProperty(s) && r[s] && e[s] && e[s].init(l, u);
            try {
              l.parse(t);
            } catch (c) {
              u.error(
                "Fatal error, cannot continue: " + c.message,
                c.line,
                c.col,
                {}
              );
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", function (e) {
              ...
              e.addListener("endstylesheet", function (e) {
                ...
                s.length &&
                  t.rollupWarn(
                    "You have " + s.join(", ") + " defined in this stylesheet.",
                    n
                  );
              });
          },
