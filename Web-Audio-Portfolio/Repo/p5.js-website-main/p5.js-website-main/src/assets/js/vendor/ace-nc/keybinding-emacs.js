        ...
        (t.handler.handleKeyboard = function (e, t, n, r) {
          ...
          if (o == "c-" || e.universalArgument) {
            ...
            if (typeof a == "number" && !isNaN(a))
              return (e.count = parseInt(u + a)), { command: "null" };
            e.universalArgument && (e.count = 4);
          }
          (e.universalArgument = !1),
            o && (n = o + n),
            e.keyChain && (n = e.keyChain += " " + n);
          var f = this.commandKeyBinding[n];
          e.keyChain = f == "null" ? n : "";
          if (!f) return undefined;
          if (f === "null") return { command: "null" };
          if (f === "universalArgument")
          ...
          exchangePointAndMark: {
            exec: function (e, t) {
              ...
              if (t.count) {
                ...
                n.clearSelection(),
                  n.moveCursorToPosition(e.popEmacsMark()),
                  e.pushEmacsMark(r);
                return;
              }
            ...
            exec: function (e) {
              t.killRing.add(e.getCopyText()),
                setTimeout(function () {
                  var t = e.selection,
                    n = t.getRange();
                  e.pushEmacsMark(t.isBackwards() ? n.end : n.start),
                    t.clearSelection();
                }, 0);
            },
            readonly: !0,
