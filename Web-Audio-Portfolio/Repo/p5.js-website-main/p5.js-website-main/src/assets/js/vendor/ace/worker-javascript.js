        ...
        function (_dereq_, module, exports) {
          ...
          var JSHINT = (function () {
            ...
            function statement() {
              ...
              if (t.id === "{") {
                var iscase =
                  funct["(verb)"] === "case" && state.tokens.curr.value === ":";
            ...
            prefix("(", function () {
              ...
              if (state.tokens.next.id !== ")") {
                for (;;) {
                  if (
                    pn1.value === "=>" &&
                    _.contains(["{", "["], state.tokens.next.value)
                  ) {
                      ...
                      default:
                        if (
                          !reg.fallsThrough.test(
                            state.lines[state.tokens.next.line - 2]
                          )
                        ) {
              ...
              if (_.contains(inof, nextop.value)) {
                ...
                if (state.tokens.next.id === "var") {
                  ...
                  switch (funct[state.tokens.next.value]) {
                    ...
                    default:
                      if (
                        !funct["(blockscope)"].getlabel(state.tokens.next.value)
                      )
                        warning(
                          "W088",
                          state.tokens.next,
              ...
              try {
                ...
                functions.forEach(function (func) {
                  ...
                  while (param) {
                    ...
                    unused_opt =
                      unused_opt === true ? "last-param" : unused_opt;
                ...
                switch (token.type) {
                  ...
                  case Token.NumericLiteral:
                    ...
                    this.triggerAsync(
                      ...
                      function () {
                        return (
                          state.directive["use strict"] && token.base === 8
                        );
                      }
                    );
