          ...
          r.addListener(n, "compositionstart", B),
            ...
            (this.moveToMouse = function (e, o) {
              ...
              t.renderer.$keepTextAreaAtCursor &&
                (t.renderer.$keepTextAreaAtCursor = null),
                i.isWin && r.capture(t.container, h, q);
            }),
        ...
        r.implement(this, d),
            ...
            (this.$highlightTagPending = !0),
              setTimeout(function () {
                ...
                e.$tagHighlight &&
                  ...
                  l &&
                    !e.$tagHighlight &&
                    (e.$tagHighlight = e.addMarker(l, "ace_bracket", "text"));
              }, 50);
          }),
          (this.focus = function () {
            var e = this;
          ...
          (this.jumpToMatching = function (e) {
            var t = this.getCursorPosition(),
              n = new y(this.session, t.row, t.column),
              r = n.getCurrentToken(),
              i = r;
            i || (i = n.stepForward());
            if (!i) return;
            ...
            do {
              if (i.value.match(/[{}()\[\]]/g))
                for (; a < i.value.length && !o; a++) {
                  if (!l[i.value[a]]) continue;
                  (f =
                    l[i.value[a]] + "." + i.type.replace("rparen", "lparen")),
                    isNaN(u[f]) && (u[f] = 0);
                  switch (i.value[a]) {
                    case "(":
                    case "[":
                    ...
                    case "]":
                    case "}":
                      u[f]--, u[f] === -1 && ((s = "bracket"), (o = !0));
                  }
                }
              else
                i &&
                  i.type.indexOf("tag-name") !== -1 &&
                  (isNaN(u[i.value]) && (u[i.value] = 0),
                  r.value === "<"
                    ? u[i.value]++
                    : r.value === "</" && u[i.value]--,
                  u[i.value] === -1 && ((s = "tag"), (o = !0)));
              o || ((r = i), (i = n.stepForward()), (a = 0));
            } while (i && !o);
            if (!s) return;
            var c;
            if (s === "bracket") {
              c = this.session.getBracketRange(t);
              if (!c) {
                c = new p(
                  n.getCurrentTokenRow(),
                  n.getCurrentTokenColumn() + a - 1,
                  n.getCurrentTokenRow(),
                  n.getCurrentTokenColumn() + a - 1
                );
                if (!c) return;
                var h = c.start;
                h.row === t.row &&
                  Math.abs(h.column - t.column) < 2 &&
                  (c = this.session.getBracketRange(h));
              }
            } else if (s === "tag") {
              if (!i || i.type.indexOf("tag-name") === -1) return;
              var d = i.value,
                c = new p(
                  n.getCurrentTokenRow(),
              ...
              if (c.compare(t.row, t.column) === 0) {
                o = !1;
                do
                  (i = r),
                    (r = n.stepBackward()),
                    r &&
                      (r.type.indexOf("tag-close") !== -1 &&
                        c.setEnd(
                          n.getCurrentTokenRow(),
                      ...
                      i.value === d &&
                        i.type.indexOf("tag-name") !== -1 &&
                        (r.value === "<" ? u[d]++ : r.value === "</" && u[d]--,
                        u[d] === 0 && (o = !0)));
                while (r && !o);
              }
              if (i && i.type.indexOf("tag-name")) {
                var h = c.start;
                h.row == t.row &&
                  Math.abs(h.column - t.column) < 2 &&
                  (h = c.end);
              ...
              h &&
                (e
                  ? c && c.isEqual(this.getSelectionRange())
                    ? this.clearSelection()
                    : this.selection.selectTo(h.row, h.column)
                  : this.selection.moveTo(h.row, h.column));
          }),
