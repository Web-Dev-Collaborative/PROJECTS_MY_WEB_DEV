          ...
          return (
            ...
            (e.prototype.closeOpenCalls = function () {
              ...
              return (
                ...
                (e = function (e, t) {
                  return (this.tokens[e[0] === "OUTDENT" ? t - 1 : t][0] =
                    "CALL_END");
                }),
                this.scanTokens(function (n, r) {
                  return (
                    n[0] === "CALL_START" && this.detectEnd(r + 1, t, e), 1
                  );
                })
              );
            }),
            (e.prototype.closeOpenIndexes = function () {
              ...
              return (
                ...
                this.scanTokens(function (n, r) {
                  return (
                    n[0] === "INDEX_START" && this.detectEnd(r + 1, t, e), 1
                  );
                })
              );
            }),
                ...
                this.scanTokens(function (t, n, r) {
                  ...
                  (H = t[0]),
                    ...
                    (_ = function (t) {
                      ...
                      (i = t != null ? t : n),
                        e.push(["(", i, { ours: !0 }]),
                        r.splice(i, 0, m("CALL_START", "("));
                      if (t == null) return (n += 1);
                    }),
                    (h = function () {
                      return (
                        e.pop(), r.splice(n, 0, m("CALL_END", ")")), (n += 1)
                      );
                    }),
                    (s = function () {
                      while (y()) h();
                    ...
                    (D = function (t, i) {
                      ...
                      i == null && (i = !0),
                        ...
                        e.push([
                          "{",
                          s,
                          { sameLine: !0, startsLine: i, ours: !0 },
                        ]),
                  ...
                  if (
                    ...
                    if (
                      ((S.call(l, H) >= 0 && t.spaced && !t.stringEnd) ||
                        (H === "?" && n > 0 && !r[n - 1].spaced)) &&
                      (S.call(a, E) >= 0 ||
                        (S.call(c, E) >= 0 &&
                    ...
                    if (H === ":") {
                      ...
                      P =
                        C === 0 ||
                        ((F = this.tag(C - 1)), S.call(p, F) >= 0) ||
                        r[C - 1].newLine;
                      if (O()) {
                        (I = O()), (A = I[0]), (L = I[1]);
                        if (
                          (A === "{" ||
                            (A === "INDENT" && this.tag(L - 1) === "{")) &&
                          (P ||
                            this.tag(C - 1) === "," ||
                            this.tag(C - 1) === "{")
                        )
              ...
              return (
                ...
                (t = function (e, t) {
                  ...
                  return (
                    (e[1] !== ";" &&
                      ...
                      !(
                        e[0] === "TERMINATOR" &&
                        ((r = this.tag(t + 1)), S.call(s, r) >= 0)
                      ) &&
                      (e[0] !== "ELSE" || o === "THEN") &&
                      (((u = e[0]) !== "CATCH" && u !== "FINALLY") ||
                        (o !== "->" && o !== "=>"))) ||
                    (((a = e[0]), S.call(i, a) >= 0) &&
                ...
                this.scanTokens(function (i, u, a) {
                  ...
                  if (l === "TERMINATOR") {
                    if (
                      this.tag(u + 1) === "ELSE" &&
                      this.tag(u - 1) !== "OUTDENT"
                    )
                      return (
                        a.splice.apply(
                          a,
                          [u, 1].concat(x.call(this.indentation()))
                        ),
                        1
                      );
                    if (((h = this.tag(u + 1)), S.call(s, h) >= 0))
                      return a.splice(u, 1), 0;
                  }
                  if (l === "CATCH")
                    for (f = c = 1; c <= 2; f = ++c) {
                      if (
                        (p = this.tag(u + f)) !== "OUTDENT" &&
                        p !== "TERMINATOR" &&
                        p !== "FINALLY"
                      )
                        continue;
                      return (
                        a.splice.apply(
                          a,
                          [u + f, 0].concat(x.call(this.indentation()))
                        ),
                        2 + f
                      );
                    }
              ...
              return (
                ...
                (t = function (e, t) {
                  ...
                  return (
                    (r = e[0]),
                    (n = this.tokens[t - 1][0]),
                    r === "TERMINATOR" || (r === "INDENT" && S.call(v, n) < 0)
                  );
                }),
                (e = function (e, t) {
        ...
        (t.flatten = s =
          function (e) {
            ...
            for (r = 0, i = e.length; r < i; r++)
              (t = e[r]), t instanceof Array ? (n = n.concat(s(t))) : n.push(t);
            return n;
          }),
        (t.del = function (e, t) {
          var n;
          ...
          return function (n) {
            return (
              typeof n == "object" &&
                ...
                n.updateLocationDataIfMissing(r(e, t)),
              n
            );
          };
        }),
        ...
        (t.baseFileName = function (e, t, n) {
          ...
          return (
            ...
            t && e.indexOf(".") >= 0
              ? ((r = e.split(".")),
                r.pop(),
                r[r.length - 1] === "coffee" && r.length > 1 && r.pop(),
                r.join("."))
              : e
          );
        }),
            ...
            return (
              ...
              (e.prototype.numberToken = function () {
                ...
                (r = n[0]),
                  /^0[BOX]/.test(r)
                    ...
                    : /^0\d+/.test(r) &&
                      this.error(
                        "octal literal '" + r + "' must be prefixed with '0o'"
                      ),
                  (t = r.length);
                if ((i = /^0o([0-7]+)/.exec(r)))
              ...
              (e.prototype.stringToken = function () {
                ...
                return n
                  ? ((r = this.removeNewlines(n.slice(1, -1))),
                    t === '"' && 0 < n.indexOf("#{", 1)
                      ? this.interpolateString(r, {
                          strOffset: 1,
                          lexedLength: n.length,
                        })
                      : this.token(
                          "STRING",
                          t + this.escapeLines(r) + t,
                          0,
                          n.length
                        ),
                    (e = /^(?:\\.|[^\\])*\\(?:0[0-7]|[1-7])/.test(n)) &&
                      this.error(
                        "octal escape sequences " + n + " are not allowed"
                      ),
                    n.length)
                  : 0;
              }),
              ...
              (e.prototype.lineToken = function () {
                ...
                if (i - this.indebt === this.indent)
                  return (
                    r ? this.suppressNewlines() : this.newlineToken(0), t.length
                  );
                if (i > this.indent) {
                  if (r)
                    return (
                  ...
                  i < this.baseIndent
                    ...
                    : ((this.indebt = 0),
                      this.outdentToken(this.indent - i, r, t.length));
              ...
              (e.prototype.whitespaceToken = function () {
                var e, t, n;
                return !(e = W.exec(this.chunk)) &&
                  !(t = this.chunk.charAt(0) === "\n")
                  ? 0
                  : ((n = K(this.tokens)),
              ...
              (e.prototype.literalToken = function () {
                var e, t, n, r, i, u, a, f;
                (e = P.exec(this.chunk))
                  ? ((r = e[0]), o.test(r) && this.tagParameters())
              ...
              (e.prototype.balancedString = function (e, t) {
                ...
                for (
                  ...
                  t !== "}" || (i !== '"' && i !== "'")
                    ? t === "}" &&
                      i === "/" &&
                      (s = m.exec(e.slice(r)) || H.exec(e.slice(r)))
                      ? (n += s[0].length - 1)
                      : t === "}" && i === "{"
                      ? u.push((t = "}"))
                      : t === '"' && o === "#" && i === "{" && u.push((t = "}"))
              ...
              (e.prototype.interpolateString = function (t, n) {
                ...
                while ((l = t.charAt((o += 1)))) {
                  ...
                  if (
                    l !== "#" ||
                    t.charAt(o + 1) !== "{" ||
                    !(i = this.balancedString(t.slice(o + 1), "}"))
                  )
                    continue;
                  m < o &&
                    T.push(this.makeToken("NEOSTRING", t.slice(m, o), E + m)),
                    (u = i.slice(1, -1));
                  if (u.length) {
                    (L = this.getLineAndColumnFromChunk(E + o + 1)),
                      ...
                      (y = d.pop()),
                      ((A = d[0]) != null ? A[0] : void 0) === "TERMINATOR" &&
                        (y = d.shift());
                    if ((f = d.length))
                      f > 1 &&
                        (d.unshift(this.makeToken("(", "(", E + o + 1, 0)),
                        d.push(
                          this.makeToken(")", ")", E + o + 1 + u.length, 0)
                        )),
                        T.push(["TOKENS", d]);
                  }
                  (o += i.length), (m = o + 1);
                ...
                o > m &&
                  m < t.length &&
                  T.push(this.makeToken("NEOSTRING", t.slice(m), E + m));
                if (b) return T;
                if (!T.length) return this.token("STRING", '""', v, c);
                T[0][0] !== "NEOSTRING" &&
                  T.unshift(this.makeToken("NEOSTRING", "", v)),
                ...
                for (o = C = 0, k = T.length; C < k; o = ++C)
                  (x = T[o]),
                    ...
                    S === "TOKENS"
                      ...
                      : S === "NEOSTRING"
                      ? ((x[0] = "STRING"),
                        (x[1] = this.makeString(N, '"', s)),
                        this.tokens.push(x))
                      : this.error("Unexpected " + S);
                return (
                  a &&
                    ((w = this.makeToken(")", ")", v + c, 0)),
                    (w.stringEnd = !0),
                    this.tokens.push(w)),
                  T
                );
              ...
              (e.prototype.getLineAndColumnFromChunk = function (e) {
                ...
                return e === 0
                  ...
                  : (e >= this.chunk.length
                      ? (i = this.chunk)
                      : (i = this.chunk.slice(0, +(e - 1) + 1 || 9e9)),
                    (n = V(i, "\n")),
                    (t = this.chunkColumn),
                    n > 0
                      ? ((r = i.split("\n")), (t = K(r).length))
          ...
          switch (s) {
            ...
            case 35:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Assign(o[a - 2], o[a]));
              break;
            case 36:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Assign(o[a - 3], o[a]));
              break;
            case 37:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Assign(o[a - 4], o[a - 1]));
              break;
            case 38:
            ...
            case 39:
              this.$ = i.addLocationDataFn(
                ...
                new i.Assign(
                  i.addLocationDataFn(u[a - 2])(new i.Value(o[a - 2])),
                  o[a],
                  "object"
                )
              );
            ...
            case 40:
              this.$ = i.addLocationDataFn(
                ...
                new i.Assign(
                  i.addLocationDataFn(u[a - 4])(new i.Value(o[a - 4])),
                  o[a - 1],
                  "object"
                )
              );
            ...
            case 48:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Code(o[a - 3], o[a], o[a - 1]));
              break;
            case 49:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.Code([], o[a], o[a - 1]));
              break;
            case 50:
            ...
            case 60:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.Param(o[a - 1], null, !0));
              break;
            case 61:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Param(o[a - 2], o[a]));
              break;
            case 62:
              this.$ = o[a];
              break;
            ...
            case 81:
              this.$ = i.addLocationDataFn(
                ...
                i.addLocationDataFn(u[a - 1])(
                  new i.Access(new i.Literal("prototype"))
                ),
                i.addLocationDataFn(u[a])(new i.Access(o[a])),
              ]);
              break;
            case 82:
              this.$ = i.addLocationDataFn(
            ...
            case 89:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Obj(o[a - 2], o[a - 3].generated));
              break;
            case 90:
              this.$ = i.addLocationDataFn(u[a], u[a])([]);
              break;
            ...
            case 96:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.Class(null, null, o[a]));
              break;
            case 97:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Class(null, o[a]));
              break;
            case 98:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Class(null, o[a - 1], o[a]));
              break;
            case 99:
            ...
            case 100:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Class(o[a - 1], null, o[a]));
              break;
            case 101:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Class(o[a - 2], o[a]));
              break;
            case 102:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Class(o[a - 3], o[a - 1], o[a]));
              break;
            case 103:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Call(o[a - 2], o[a], o[a - 1]));
              break;
            case 104:
              this.$ = i.addLocationDataFn(
                u[a - 2],
            ...
            case 105:
              this.$ = i.addLocationDataFn(
                u[a],
                u[a]
              )(new i.Call("super", [new i.Splat(new i.Literal("arguments"))]));
              break;
            case 106:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.Call("super", o[a]));
              break;
            case 107:
            ...
            case 113:
              this.$ = i.addLocationDataFn(
                ...
                new i.Value(
                  i.addLocationDataFn(u[a - 1])(new i.Literal("this")),
                  [i.addLocationDataFn(u[a])(new i.Access(o[a]))],
                  "this"
                )
              );
            ...
            case 118:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Range(o[a - 3], o[a - 1], o[a - 2]));
              break;
            case 119:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Range(o[a - 2], o[a], o[a - 1]));
              break;
            case 120:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.Range(o[a - 1], null, o[a]));
              break;
            case 121:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.Range(null, o[a], o[a - 1]));
              break;
            case 122:
              this.$ = i.addLocationDataFn(
                u[a],
                u[a]
              )(new i.Range(null, null, o[a]));
              break;
            case 123:
              this.$ = i.addLocationDataFn(u[a], u[a])([o[a]]);
              break;
            ...
            case 133:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Try(o[a - 1], o[a][0], o[a][1]));
              break;
            case 134:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Try(o[a - 2], null, null, o[a]));
              break;
            case 135:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Try(o[a - 3], o[a - 2][0], o[a - 2][1], o[a]));
              break;
            case 136:
            ...
            case 137:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )([i.addLocationDataFn(u[a - 1])(new i.Value(o[a - 1])), o[a]]);
              break;
            case 138:
            ...
            case 143:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.While(o[a - 2], { guard: o[a] }));
              break;
            case 144:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )(new i.While(o[a], { invert: !0 }));
              break;
            case 145:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.While(o[a - 2], { invert: !0, guard: o[a] }));
              break;
            case 146:
              this.$ = i.addLocationDataFn(
                u[a - 1],
            ...
            case 147:
              this.$ = i.addLocationDataFn(
                ...
                o[a].addBody(
                  i.addLocationDataFn(u[a - 1])(i.Block.wrap([o[a - 1]]))
                )
              );
              break;
            case 148:
            ...
            case 150:
              this.$ = i.addLocationDataFn(
                ...
                new i.While(
                  i.addLocationDataFn(u[a - 1])(new i.Literal("true"))
                ).addBody(o[a])
              );
              break;
            case 151:
              this.$ = i.addLocationDataFn(
                ...
                new i.While(
                  i.addLocationDataFn(u[a - 1])(new i.Literal("true"))
                ).addBody(i.addLocationDataFn(u[a])(i.Block.wrap([o[a]])))
              );
              break;
            case 152:
              this.$ = i.addLocationDataFn(
            ...
            case 155:
              this.$ = i.addLocationDataFn(
                u[a - 1],
                u[a]
              )({ source: i.addLocationDataFn(u[a])(new i.Value(o[a])) });
              break;
            case 156:
              this.$ = i.addLocationDataFn(
                u[a - 1],
            ...
            case 167:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )({ source: o[a - 2], guard: o[a] });
              break;
            case 168:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )({ source: o[a - 2], guard: o[a], object: !0 });
              break;
            case 169:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )({ source: o[a - 2], step: o[a] });
              break;
            case 170:
              this.$ = i.addLocationDataFn(
                u[a - 5],
                u[a]
              )({ source: o[a - 4], guard: o[a - 2], step: o[a] });
              break;
            case 171:
              this.$ = i.addLocationDataFn(
                u[a - 5],
                u[a]
              )({ source: o[a - 4], step: o[a - 2], guard: o[a] });
              break;
            case 172:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Switch(o[a - 3], o[a - 1]));
              break;
            case 173:
              this.$ = i.addLocationDataFn(
                u[a - 6],
                u[a]
              )(new i.Switch(o[a - 5], o[a - 3], o[a - 1]));
              break;
            case 174:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Switch(null, o[a - 1]));
              break;
            case 175:
              this.$ = i.addLocationDataFn(
                u[a - 5],
                u[a]
              )(new i.Switch(null, o[a - 3], o[a - 1]));
              break;
            case 176:
              this.$ = o[a];
              break;
            ...
            case 184:
              this.$ = i.addLocationDataFn(
                ...
                new i.If(
                  o[a],
                  i.addLocationDataFn(u[a - 2])(i.Block.wrap([o[a - 2]])),
                  { type: o[a - 1], statement: !0 }
                )
              );
              break;
            case 185:
            ...
            case 200:
              this.$ = i.addLocationDataFn(
                ...
                (function () {
                  return o[a - 1].charAt(0) === "!"
                    ? new i.Op(o[a - 1].slice(1), o[a - 2], o[a]).invert()
                    : new i.Op(o[a - 1], o[a - 2], o[a]);
                })()
              );
              break;
            case 201:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Assign(o[a - 2], o[a], o[a - 1]));
              break;
            case 202:
              this.$ = i.addLocationDataFn(
                u[a - 4],
                u[a]
              )(new i.Assign(o[a - 4], o[a - 1], o[a - 3]));
              break;
            case 203:
              this.$ = i.addLocationDataFn(
                u[a - 3],
                u[a]
              )(new i.Assign(o[a - 3], o[a], o[a - 2]));
              break;
            case 204:
              this.$ = i.addLocationDataFn(
                u[a - 2],
                u[a]
              )(new i.Extends(o[a - 2], o[a]));
          }
        },
        table: [
          {
              ...
              this.lexer.showPosition
                ...
                : (L =
                    ...
                    (g == h
                      ? "end of input"
                      : "'" + (this.terminals_[g] || g) + "'")),
                this.lexer.yylloc.first_line !== p.first_line &&
                  (p = this.lexer.yylloc),
                this.parseError(L, {
          ...
          (function () {
            ...
            return (
              ...
              (e.prototype.namedMethod = function () {
                var e;
                return ((e = this.method) != null ? e.name : void 0) ||
                  !this.parent
                  ? this.method
              ...
              (e.prototype.check = function (e) {
                ...
                return !!(
                  this.type(e) ||
                  ((t = this.parent) != null ? t.check(e) : void 0)
                );
              }),
              ...
              (e.prototype.declaredVariables = function () {
                ...
                for (r = 0, i = s.length; r < i; r++)
                  (n = s[r]),
                    n.type === "var" &&
                      (n.name.charAt(0) === "_" ? t : e).push(n.name);
    ...
    function (e, t, n) {
      ...
      (Error.stackTraceLimit = Infinity),
          ...
          (function () {
            ...
            return (
              ...
              (e.prototype.compileClosure = function (e) {
                var t, n, i, s, o;
                (s = this.jumps()) &&
                  s.error("cannot use a pure statement in an expression"),
                  (e.sharedScope = !0),
                  (i = new l([], u.wrap([this]))),
                  (t = []);
                if ((n = this.contains(ft)) || this.contains(lt))
                  (t = [new O("this")]),
                    n
                      ? ((o = "apply"), t.push(new O("arguments")))
                      : (o = "call"),
              ...
              (e.prototype.cache = function (e, t, n) {
                ...
                return this.isComplex()
                  ? ((r = new O(n || e.scope.freeVariable("ref"))),
                    (i = new s(r, this)),
                    t
                      ? [i.compileToFragments(e, t), [this.makeCode(r.value)]]
                      : [i, r])
              ...
              (e.prototype.makeReturn = function (e) {
                ...
                return (
                  (t = this.unwrapAll()),
                  e ? new a(new O("" + e + ".push"), [t]) : new R(t)
                );
              }),
              ...
              (t.prototype.compileNode = function (e) {
                  ...
                  (o = l[s]),
                    ...
                    o instanceof t
                      ...
                      ? ((o.front = !0),
                        ...
                        o.isStatement(e) ||
                          (i.unshift(this.makeCode("" + this.tab)),
                ...
                return u
                  ? this.spaced
                    ...
                    : this.joinFragmentArrays(r, "\n")
                  : (r.length
                      ? (n = this.joinFragmentArrays(r, ", "))
                      : (n = [this.makeCode("void 0")]),
                  ...
                  a.expressions === this &&
                    ...
                    n || t
                      ? (s && i.push(this.makeCode("\n")),
                        ...
                        n &&
                          i.push(
                            this.makeCode(a.declaredVariables().join(", "))
                          ),
                        t &&
                          (n && i.push(this.makeCode(",\n" + (this.tab + J))),
                          i.push(
                            this.makeCode(
                              a.assignedVariables().join(",\n" + (this.tab + J))
                            )
                          )),
                        i.push(
                          this.makeCode(";\n" + (this.spaced ? "\n" : ""))
            ...
            return (
              ...
              (t.prototype.jumps = function (e) {
                if (
                  this.value === "break" &&
                  !(
                    (e != null ? e.loop : void 0) ||
                    (e != null ? e.block : void 0)
                  )
                )
                  return this;
                if (
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  this.expression &&
                    (t = t.concat(this.expression.compileToFragments(e, L))),
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.isObject = function (e) {
                return this.properties.length
                  ? !1
                  : this.base instanceof H && (!e || this.base.generated);
              }),
              ...
              (t.prototype.looksStatic = function (e) {
                ...
                return (
                  ...
                  ((t = this.properties[0].name) != null ? t.value : void 0) !==
                    "prototype"
                );
              }),
              (t.prototype.unwrap = function () {
                ...
                return (
                  ...
                  (i != null ? !i.isComplex() : !void 0)
                    ...
                    : ((n = new t(this.base, this.properties.slice(0, -1))),
                      n.isComplex() &&
                        ((r = new O(e.scope.freeVariable("base"))),
                        (n = new t(new F(new s(r, n))))),
                      i
                        ? (i.isComplex() &&
                            ((o = new O(e.scope.freeVariable("name"))),
                            (i = new x(new s(o, i.index))),
                            (o = new x(o))),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                (this.base.front = this.front),
                  ...
                  (this.base instanceof F || r.length) &&
                    U.test(at(t)) &&
                    t.push(this.makeCode("."));
                  ...
                  : (this.unfoldedSoak = (function (n) {
                      return function () {
                        ...
                        if ((o = n.base.unfoldSoak(e)))
                          return (
                            (h = o.body.properties).push.apply(h, n.properties),
                            o
                          );
                        d = n.properties;
                        for (i = l = 0, c = d.length; l < c; i = ++l) {
                          ...
                          return (
                            ...
                            r.isComplex() &&
                              ((a = new O(e.scope.freeVariable("ref"))),
                              (r = new F(new s(a, r))),
                              (f.base = a)),
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.newInstance = function () {
                ...
                return (
                  (e =
                    ((n = this.variable) != null ? n.base : void 0) ||
                    this.variable),
                  e instanceof t && !e.isNew
                    ? e.newInstance()
                    : (this.isNew = !0),
                  this
                );
              ...
              (t.prototype.superThis = function (e) {
                var t;
                return (
                  (t = e.scope.method), (t && !t.klass && t.context) || "this"
                );
              }),
              (t.prototype.unfoldSoak = function (e) {
                var n, r, i, s, o, u, a, f, l;
                if (this.soak) {
                  if (this.variable) {
                    ...
                    (f = new Z(this.variable).cacheReference(e)),
                      (i = f[0]),
                      (o = f[1]);
              ...
              (t.prototype.compileNode = function (e) {
                var t, n, r, i, s, o, u, a, f, l;
                (f = this.variable) != null && (f.front = this.front),
                  (i = V.compileSplattedArray(e, this.args, !0));
                if (i.length) return this.compileSplat(e, i);
                (r = []), (l = this.args);
                for (n = u = 0, a = l.length; u < a; n = ++u)
                  (t = l[n]),
                    n && r.push(this.makeCode(", ")),
                    r.push.apply(r, t.compileToFragments(e, C));
                return (
                  (s = []),
                  this.isSuper
                    ? ((o =
                  ...
                  : ((n = []),
                    ...
                    (o = r.properties.pop()) && r.isComplex()
                      ...
                      : ((i = r.compileToFragments(e, T)),
                        ...
                        o
                          ? ((u = at(i)),
                            i.push.apply(i, o.compileToFragments(e)))
                          : (u = "null"),
                        (n = n.concat(i))),
                    (n = n.concat(
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileToFragments = function (e) {
                return new a(new Z(new O(wt("extends"))), [
                  this.child,
                  this.parent,
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileToFragments = function (e) {
                return [].concat(
                  this.makeCode("["),
                  this.index.compileToFragments(e, L),
                  this.makeCode("]")
                );
              }),
              (t.prototype.isComplex = function () {
            ...
            return (
              ...
              (t.prototype.compileVariables = function (e) {
                ...
                (e = pt(e, { top: !0 })),
                  ...
                  (this.toVar = r[1]);
                if ((t = it(e, "step")))
                  (i = this.cacheToCodeFragments(t.cache(e, C))),
                    (this.step = i[0]),
                    (this.stepVar = i[1]);
                (s = [this.fromVar.match(P), this.toVar.match(P)]),
                  (this.fromNum = s[0]),
                  (this.toNum = s[1]);
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                (r = e.indent += J),
                  (u = this.lastNonComment(this.properties)),
                  (t = []);
            ...
            return (
              ...
              (t.prototype.setContext = function (e) {
                return this.body.traverseChildren(!1, function (t) {
                  ...
                  if (t instanceof O && t.value === "this")
                    return (t.value = e);
                  if (t instanceof l) {
                    t.klass = e;
                        ...
                        o.value === "constructor"
                          ? (this.ctor &&
                            ...
                            a instanceof l
                              ? (i = this.ctor = a)
                              : ((this.externalCtor =
                                  n.classScope.freeVariable("class")),
                                (i = new s(new O(this.externalCtor), a))))
                          : i.variable["this"]
                          ? (a["static"] = !0)
                          : ((i.variable = new Z(new O(t), [
                              new r(new O("prototype")),
                              new r(o),
                            ])),
                            a instanceof l &&
                              a.bound &&
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  (i = this.body.jumps()) &&
                    i.error("Class bodies cannot contain pure statements"),
                  (n = this.body.contains(ft)) &&
          ...
          (function (e) {
            function t(e, t, n, r) {
              ...
              (this.variable = e),
                ...
                i &&
                  this.context !== "object" &&
                  this.variable.error('variable name may not be "' + s + '"');
            }
            return (
              Tt(t, e),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                if (!this.context) {
                  (u = this.variable.unwrapAll()),
                    u.isAssignable() ||
                      this.variable.error(
                        '"' + this.variable.compile(e) + '" cannot be assigned'
                      );
                  if (
                    typeof u.hasProperties == "function"
                      ? !u.hasProperties()
                      : !void 0
                  )
              ...
              (t.prototype.compilePatternMatch = function (e) {
                ...
                (b = e.level === A),
                  (E = this.value),
                  (p = this.variable.base.objects);
                if (!(d = p.length))
                  return (
                    (s = E.compileToFragments(e)),
                    e.level >= k ? this.wrapInBraces(s) : s
                  );
                f = this.variable.isObject();
                if (!b || d !== 1 || (h = p[0]) instanceof V) {
                  (S = E.compileToFragments(e, C)),
                    (T = at(S)),
                    (i = []),
                    (y = !1);
                  ...
                  for (u = N = 0, L = p.length; N < L; u = ++N)
                    (h = p[u]),
                      ...
                      f &&
                        (h instanceof t
                          ? ((P = h),
                            ...
                            (h = P.value))
                          : h.base instanceof F
                          ? ((B = new Z(h.unwrapAll()).cacheReference(e)),
                            (h = B[0]),
                            (a = B[1]))
                      ...
                      c != null &&
                        Nt.call(I, c) >= 0 &&
                        h.error(
                          "assignment to a reserved word: " + h.compile(e)
                        ),
                      i.push(
                        new t(h, w, null, {
                          param: this.param,
                ...
                return (
                  ...
                  new t(h, E, null, { param: this.param }).compileToFragments(
                    e,
                    A
                  )
                );
                ...
                return (
                  ...
                  Nt.call(this.context, "?") >= 0
                    ? ((e.isExistentialEquals = !0),
                      new E(new p(r), i, { type: "if" })
                        .addElse(new t(i, this.value, "="))
                        .compileToFragments(e))
                    : ((n = new B(
              ...
              (t.prototype.compileSplice = function (e) {
                ...
                return (
                  ...
                  r
                    ? ((c = this.cacheToCodeFragments(r.cache(e, k))),
                      (i = c[0]),
                      (s = c[1]))
                    : (i = s = "0"),
                  u
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                for (l = P = 0, _ = d.length; P < _; l = ++P)
                  (h = d[l]),
                    (d[l] = h.compileToFragments(e)),
                    e.scope.parameter(at(d[l]));
                (g = []),
                  ...
                  : ((t = this.name),
                    t["this"]
                      ? ((t = t.properties[0].name),
                        t.value.reserved &&
                          (t = new O(e.scope.freeVariable(t.value))))
                      : t.isComplex() &&
                        (t = new O(e.scope.freeVariable("arg"))),
                    (t = new Z(t)),
        ...
        (t.While = et =
          (function (e) {
            function t(e, t) {
              (this.condition = (t != null ? t.invert : void 0)
                ? e.invert()
                : e),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  n.isEmpty()
                    ? (n = this.makeCode(""))
                    : (this.returns &&
                        (n.makeReturn((r = e.scope.freeVariable("results"))),
                        (i = "" + this.tab + r + " = [];\n")),
                      this.guard &&
                        (n.expressions.length > 1
                          ? n.expressions.unshift(
                              new E(
                                new F(this.guard).invert(),
                                new O("continue")
                              )
                            )
        ...
        (t.Op = B =
          (function (e) {
            function r(e, n, r, i) {
              ...
              if (e === "new") {
                if (n instanceof a && !n["do"] && !n.isNew)
            ...
            return (
              ...
              (t = { "==": "===", "!=": "!==", of: "in" }),
              (n = { "!==": "===", "===": "!==" }),
              (r.prototype.children = ["first", "second"]),
              (r.prototype.isSimpleNumber = D),
              ...
              (r.prototype.invert = function () {
                ...
                if (this.isChainable() && this.first.isChainable()) {
                  ...
                  while (t && t.operator)
                    (t.invert = !t.invert),
                      (t.operator = n[t.operator]),
                      (t = t.first);
                  return this;
                }
                return (s = n[this.operator])
                  ? ((this.operator = s),
                    this.first.unwrap() instanceof r && this.first.invert(),
                    this)
                  : this.second
                  ? new F(this).invert()
                  : this.operator === "!" &&
                    (i = this.first.unwrap()) instanceof r &&
                    ((o = i.operator) === "!" ||
                      o === "in" ||
                      o === "instanceof")
                  ? i
              ...
              (r.prototype.generateDo = function (e) {
                ...
                (i = []),
                  (n =
                    e instanceof s && (o = e.value.unwrap()) instanceof l
                      ? o
                      : e),
                  (c = n.params || []);
              ...
              (r.prototype.compileExistence = function (e) {
                ...
                return (
                  this.first.isComplex()
                    ? ((n = new O(e.scope.freeVariable("ref"))),
                      (t = new F(new s(n, this.first))))
                    : ((t = this.first), (n = t)),
                  new E(new p(t), n, { type: "if" })
                    .addElse(this.second)
                    .compileToFragments(e)
                );
              }),
              (r.prototype.compileUnary = function (e) {
                ...
                (i = t === "+" || t === "-"),
                  (t === "new" ||
                    ...
                    t === "delete" ||
                    (i &&
                      this.first instanceof r &&
                      this.first.operator === t)) &&
                    n.push([this.makeCode(" ")]);
                if (
                  (i && this.first instanceof r) ||
                  (t === "new" && this.first.isStatement(e))
                )
                  this.first = new F(this.first);
                return (
                  n.push(this.first.compileToFragments(e, k)),
                  this.flip && n.reverse(),
                  this.joinFragmentArrays(n, "")
                );
              }),
              (r.prototype.toString = function (e) {
                return r.__super__.toString.call(
                  this,
                  e,
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  (t = this.recovery
                    ? ((r = new O("_error")),
                      this.errorVariable
                        ? this.recovery.unshift(new s(this.errorVariable, r))
                        : void 0,
                      [].concat(
                        this.makeCode(" catch ("),
                        r.compileToFragments(e),
            ...
            return (
              ...
              (t.prototype.compileNode = function (e) {
                ...
                return (
                  ...
                  this.step &&
                    !this.range &&
                    ((W = this.cacheToCodeFragments(this.step.cache(e, C))),
                    (B = W[0]),
                    (I = W[1]),
                    (j = I.match(P))),
                  this.pattern && (T = y),
                  ...
                  (d = this.tab + J),
                  this.range
                    ? (h = H.compileToFragments(
                        pt(e, { index: y, name: T, step: this.step })
                      ))
                    : ((q = this.source.compile(e, C)),
                      ...
                      this.object ||
                        (B !== I && (f += "" + this.tab + B + ";\n"),
                        (this.step && j && (c = vt(j[0]) < 0)) ||
                          (x = D.freeVariable("len")),
                        (o = "" + w + y + " = 0, " + x + " = " + q + ".length"),
                        (a = "" + w + y + " = " + q + ".length - 1"),
                        (r = "" + y + " < " + x),
                        (i = "" + y + " >= 0"),
                  ...
                  this.guard &&
                    (t.expressions.length > 1
                      ? t.expressions.unshift(
                          new E(new F(this.guard).invert(), new O("continue"))
                        )
                      : this.guard && (t = u.wrap([new E(this.guard, t)]))),
                  this.pattern &&
                    t.expressions.unshift(
                      new s(this.name, new O("" + q + "[" + b + "]"))
                    ),
                ...
                for (u = h = 0, p = d.length; h < p; u = ++h) {
                  ...
                  (o = ((b = c.base) != null ? b.unwrapAll() : void 0) || c),
                    ...
                    (r = r.concat(
                      ...
                      new s(f, o).compileToFragments(e, A),
                      this.makeCode(";\n")
                    ));
                }
                return r;
            ...
            return (
              ...
              (t.prototype.makeReturn = function (e) {
                ...
                return (
                  e &&
                    (this.otherwise ||
                      (this.otherwise = new u([new O("void 0")]))),
              ...
              (t.prototype.compileNode = function (e) {
                ...
                (a = e.indent + J),
                  ...
                  (o = [].concat(
                    ...
                    this.subject
                      ? this.subject.compileToFragments(e, L)
                      : this.makeCode("false"),
                    this.makeCode(") {\n")
                  )),
                  (d = this.cases);
                  ...
                  this.otherwise &&
                    ...
                    o.push.apply(
                      ...
                      [this.makeCode(a + "default:\n")].concat(
                        Ct.call(this.otherwise.compileToFragments(e, A)),
                        [this.makeCode("\n")]
                      )
                    ),
            ...
            return (
              ...
              (t.prototype.makeReturn = function (e) {
                return (
                  e &&
                    (this.elseBody ||
                      (this.elseBody = new u([new O("void 0")]))),
                ...
                return (
                  ...
                  o
                    ...
                    : ((a = e.indent + J),
                      ...
                      (r = this.ensureBlock(this.body).compileToFragments(
                        pt(e, { indent: a })
                      )),
                      (u = [].concat(
                        this.makeCode("if ("),
                      ...
                      this.elseBody
                        ? ((n = u.concat(this.makeCode(" else "))),
                          this.isChain
                            ? ((e.chainChild = !0),
                              (n = n.concat(
                                this.elseBody.unwrap().compileToFragments(e, A)
                              )))
                            : (n = n.concat(
                                this.makeCode("{\n"),
