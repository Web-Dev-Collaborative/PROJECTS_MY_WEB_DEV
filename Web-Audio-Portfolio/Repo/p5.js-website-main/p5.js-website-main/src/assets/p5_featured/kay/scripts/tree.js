...
function Tree() {
  var twirling = loadAnimation(
    loadSpriteSheet("images/tree.png", 186, 179.7, 12)
  );
  var twirlingOver = loadAnimation(
    loadSpriteSheet("images/tree-over.png", 186, 179.7, 12)
  );
  ...
  this.update = function (vw) {
    ...
    this.sprite.onMouseReleased = function () {
      ...
      food.style.transform =
        "rotate(" + getRandomInt(180) + "deg) scale(" + random(0.1, 0.3) + ")";
