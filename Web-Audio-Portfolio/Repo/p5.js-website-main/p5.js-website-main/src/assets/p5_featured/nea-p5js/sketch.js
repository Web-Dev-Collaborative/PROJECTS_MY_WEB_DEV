...
var startText1 =
  "The National Endowment for the Arts supports art practices (like ALL of these) across the USA. NEA funds partly supported the last p5.js Contributors Conference.";
var startText2 =
  "The current US government wants to dismantle the NEA. Yet the NEA's modest budget amounts to less than 0.025% of the public funds spent on the US military.";
var startText3 =
  "In the United States Census in 2000, more people identified their primary occupation as artist, than as lawyer, doctor, or police officer combined.*";
...
function mousePressed() {
  ...
  if (
    mouseX < bs[2].position.x + 74 &&
    mouseX > bs[2].position.x - 82 &&
    mouseY < bs[2].position.y + 11 &&
    mouseY > bs[2].position.y - 25
  ) {
    console.log("clicked");
