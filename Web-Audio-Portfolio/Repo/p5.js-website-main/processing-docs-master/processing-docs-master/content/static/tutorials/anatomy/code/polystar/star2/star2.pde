void setup( )
{
  ...
  noFill();
  star(3, 60, 75, 100, 100, -PI / 2.0, cos(PI / 3.0)); // -90 degrees
  star(4, 170, 75, 25, cos(PI / 4.0));  // use simpler call

  fill(255, 204, 255);
  stroke(128, 0, 128);
  star(5, 60, 200, 75, 50, -PI / 2.0, cos(PI / 5.0)); // -90 degrees

  noFill();
  stroke(0);
  star(6, 170, 200, 50, 100, 0, cos(PI / 6.0));
  stroke(128);
