...
$(document).ready(function () {
  ...
  $("#amplitude-get-active-playlist").on("click", function () {
    ...
    $("#amplitude-function-output-pre").append(
      "Current Config: " + JSON.stringify(config, null, 4)
    );
  });
  ...
  $("#amplitude-get-repeat-playlist").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      'Repeat Playlist "trip_hop": ' + repeat
    );
  ...
  $("#amplitude-get-shuffle-playlist").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      'Shuffle Playlist "trip_hop": ' + shuffle
    );
  ...
  $("#amplitude-set-default-album-art").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Set Default Album Art To: /test/default/album-art.jpg"
    );
  ...
  $("#amplitude-get-song-played-percentage").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Song Played Percentage: " + songPlayedPercentage
    );
  ...
  $("#amplitude-get-active-song-metadata").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Parameter Ran: " + JSON.stringify(activeMetaData, null, 4)
    );
  ...
  $("#amplitude-get-active-playlist-metadata").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Active Playlist Meta Data: " + JSON.stringify(activeMetaData, null, 4)
    );
  ...
  $("#amplitude-get-song-by-index").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Song at Index 4: " + JSON.stringify(songAtIndex, null, 4)
    );
  ...
  $("#amplitude-get-song-at-playlist-index").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Song on Trip Hop Playlist at Index 2: " +
        JSON.stringify(songAtIndex, null, 4)
    );
  ...
  $("#amplitude-add-song").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Song Added: " + JSON.stringify(song, null, 4)
    );
  ...
  $("#amplitude-add-song-to-playlist").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Song Added To Trip Hop Playlist: " + JSON.stringify(song, null, 4)
    );
  ...
  $("#amplitude-remove-song").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Removed song at index 2 (Anvil by Lorn)"
    );
  ...
  $("#amplitude-remove-song-from-playlist").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Removed song at index 2 from Trip Hop (Terrain by pg.Lost)"
    );
  ...
  $("#amplitude-play-now").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Play Now: " + JSON.stringify(song, null, 4)
    );
  ...
  $("#amplitude-play-song-at-playlist-index").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Playing song at index 2 in playlist Trip Hop"
    );
  ...
  $("#amplitude-get-songs").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Songs: " + JSON.stringify(songs, null, 4)
    );
  ...
  $("#amplitude-get-songs-in-playlist").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Songs In Playlist (Trip Hop): " + JSON.stringify(songs, null, 4)
    );
  ...
  $("#amplitude-skip-to").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Skipped to 30 seconds in to Anvil by Lorn"
    );
  ...
  $("#amplitude-skip-to-playlist").on("click", function () {
    ...
    $("#amplitude-function-output").html(
      "Skipped to 30 seconds in to Vorel by Russian Circles in Trip Hop"
    );
  ...
  $("#amplitude-set-meta-data").on("click", function () {
    ...
    Amplitude.setSongMetaData(11, {
      cover_art_url:
        "https://i1.sndcdn.com/artworks-000418522386-a2wdzw-large.jpg",
    });
  ...
  $("#amplitude-set-meta-data-playlist").on("click", function () {
    ...
    Amplitude.setSongMetaData(
      3,
      { name: "META DATA UPDATED", album: "META DATA UPDATED" },
      "trip_hop"
    );

    $("#amplitude-function-output").html(
      "Set song meta data for Vorel in playlist Trip Hop."
    );
