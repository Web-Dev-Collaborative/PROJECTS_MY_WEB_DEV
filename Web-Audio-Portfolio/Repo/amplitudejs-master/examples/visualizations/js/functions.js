...
document
  .getElementsByClassName("visualization-toggle")[0]
  .addEventListener("click", function () {
    if (this.classList.contains("visualization-off")) {
      ...
      document.getElementById("large-now-playing-album-art").style.display =
        "none";
...
document
  .getElementsByClassName("arrow-up-icon")[0]
  .addEventListener("click", function () {
    document.getElementById("visualizations-player-playlist").style.display =
      "block";
  });

document
  .getElementsByClassName("arrow-down-icon")[0]
  .addEventListener("click", function () {
    document.getElementById("visualizations-player-playlist").style.display =
      "none";
  });
