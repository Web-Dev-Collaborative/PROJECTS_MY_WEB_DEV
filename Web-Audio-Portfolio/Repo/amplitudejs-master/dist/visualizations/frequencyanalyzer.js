function FrequencyAnalyzerVisualization() {
  ...
  this.renderGradientAnimation = function () {
    this.requestAnimation = requestAnimationFrame(
      this.renderGradientAnimation.bind(this)
    );
    this.x = 0;
  ...
  this.renderDynamicColorAnimation = function () {
    this.requestAnimation = requestAnimationFrame(
      this.renderDynamicColorAnimation.bind(this)
    );
    ...
    for (var i = 0; i < this.buffer; i++) {
      ...
      this.context.fillStyle =
        ...
        ", " +
        this.preferences.green +
        ", " +
        this.preferences.blue +
        ")";
      this.context.fillRect(
        this.x,
  ...
  this.renderSingleColorAnimation = function () {
    this.requestAnimation = requestAnimationFrame(
      this.renderSingleColorAnimation.bind(this)
    );
