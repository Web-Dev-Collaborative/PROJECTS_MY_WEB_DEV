      ...
      var u = a(0),
        ...
        L = (function () {
          ...
          function u(e, t) {
            ...
            s(e),
              S.default.destroyAudioBindings(),
              (n.default.audio = new Audio(e.url)),
              S.default.rebindAudio(),
        ...
        J = (function () {
          ...
          function a(e) {
            if (
              ...
              0 == i.default.songs.length && !e.starting_playlist)
            ) {
              var t = Object.keys(i.default.playlists)[0];
              E.default.changeSongPlaylist(
                t,
                i.default.playlists[t].songs[0],
                0
              );
            }
          ...
          function y(e) {
            return (
              !(!e.songs || 0 == e.songs.length) ||
              !!(e.playlists && d(e.playlists) > 0) ||
              (v.default.writeMessage(
          ...
          function T() {
            for (
              ...
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
                ...
                ? (e[t].removeEventListener("touchend", j.default.handle),
                  e[t].addEventListener("touchend", j.default.handle))
                : (e[t].removeEventListener("click", j.default.handle),
                  e[t].addEventListener("click", j.default.handle));
          }
          function C() {
            for (
              var e = document.getElementsByClassName("amplitude-shuffle"),
          ...
          function D() {
            for (
              ...
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
                ...
                ? (e[t].removeEventListener("touchend", F.default.handle),
                  e[t].addEventListener("touchend", F.default.handle))
                : (e[t].removeEventListener("click", F.default.handle),
                  e[t].addEventListener("click", F.default.handle));
          }
          function V() {
            Y.default.determineIfUsingWaveforms() &&
              (n.default.audio.removeEventListener(
    ...
    function (e, t, a) {
      ...
      var u = a(0),
        ...
        g = (function () {
          ...
          function l(e) {
            r.default.newPlaylist(null) &&
              (p.default.setActivePlaylist(null),
              p.default.changeSong(n.default.songs[e], e)),
              r.default.newSong(null, e) &&
                p.default.changeSong(n.default.songs[e], e),
              o.default.play(),
              y.default.sync();
          }
      ...
      var u = a(0),
        ...
        g = (function () {
          ...
          function l(e) {
            r.default.newPlaylist(null) &&
              (p.default.setActivePlaylist(null),
              p.default.changeSong(n.default.songs[e], e, !0)),
              r.default.newSong(null, e) &&
                p.default.changeSong(n.default.songs[e], e, !0),
              n.default.audio.paused ? o.default.play() : o.default.pause(),
              y.default.sync();
        ...
        V = (function () {
          ...
          function P(e) {
            d.default.is_touch_moving ||
              (m.default.setRepeatSong(!d.default.repeat_song),
              S.default.syncRepeatSong());
          }
          function L() {
          ...
          function Y(e) {
            return (
              ...
              R.default.isSoundCloudURL(e.url) &&
                R.default.resolveIndividualStreamableURL(
                  e.url,
                  null,
          ...
          function ee(e) {
            o.default.stop(),
              h.default.newPlaylist(null) &&
                (y.default.setActivePlaylist(null),
                y.default.changeSong(d.default.songs[e], e)),
              h.default.newSong(null, e) &&
                y.default.changeSong(d.default.songs[e], e),
              o.default.play(),
              p.default.setPlayerState(),
              N.default.sync();
          ...
          function te(e, t) {
            o.default.stop(),
              h.default.newPlaylist(t) &&
                (y.default.setActivePlaylist(t),
                y.default.changeSongPlaylist(
                  t,
                  d.default.playlists[t].songs[e],
                  e
                )),
              h.default.newSong(t, e) &&
                y.default.changeSongPlaylist(
                  t,
                  d.default.playlists[t].songs[e],
                  e
            ...
            (e = parseInt(e)),
              null != a
                ? (h.default.newPlaylist(a) && y.default.setActivePlaylist(a),
                  ...
                  o.default.play(),
                  N.default.syncGlobal(),
                  N.default.syncPlaylist(),
                  N.default.syncSong(),
                  o.default.skipToLocation(e))
                : (y.default.changeSong(d.default.songs[t], t),
                  o.default.play(),
                  N.default.syncGlobal(),
                  N.default.syncSong(),
                  o.default.skipToLocation(e));
          ...
          function _e(e, t) {
            if (void 0 != d.default.playlists[e]) {
              ...
              B.default.writeMessage("You must provide a valid playlist key!");
          }
          function he(e) {
            d.default.delay = e;
          }
          ...
          return {
            ...
            addSongToPlaylist: J,
            removeSong: Q,
            removeSongFromPlaylist: K,
            playNow: Z,
            playSongAtIndex: ee,
            playPlaylistSongAtIndex: te,
            play: ae,
            pause: le,
            stop: ue,
            getAudio: ne,
            ...
            prev: se,
            getSongs: oe,
            getSongsInPlaylist: fe,
            getSongsState: re,
            getSongsStatePlaylist: ce,
            getActiveIndex: pe,
            getVersion: ve,
            getBuffered: ye,
            skipTo: ge,
            setSongMetaData: me,
            setPlaylistMetaData: _e,
            setDelay: he,
            getDelay: be,
            getPlayerState: Ae,
            addPlaylist: $,
            registerVisualization: xe,
            setPlaylistVisualization: Me,
            setSongVisualization: Pe,
            setSongInPlaylistVisualization: Se,
            setGlobalVisualization: Le,
            getVolume: Ee,
            setVolume: we,
          };
        })();
