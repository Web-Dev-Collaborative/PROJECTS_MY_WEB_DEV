...
export default class Pan extends Interface {
  ...
  sizeInterface() {
    ...
    if (this.orientation === "vertical") {
      ...
      this.knobData.level =
        h - this.knobData.r - this.normalized * (h - this.knobData.r * 2);
      ...
      this.knobData.r = this.thickness * 0.8;
      this.knobData.level =
        this.normalized * (w - this.knobData.r * 2) + this.knobData.r;
  ...
  render() {
    ...
    if (this.orientation === "vertical") {
      this.knobData.level =
        this.knobData.r +
        this._value.normalized * (this.height - this.knobData.r * 2);
      this.knob.setAttribute("cy", this.height - this.knobData.level);
    } else {
      this.knobData.level =
        this._value.normalized * (this.width - this.knobData.r * 2) +
        this.knobData.r;
      this.knob.setAttribute("cx", this.knobData.level);
    }
  }
