(function (root, factory) {
  ...
  Module(function (Tone) {
    ...
    var blob = new Blob([
      ...
      "var timeoutTime = " +
        Tone.Clock._updateInterval * 1000 +
        ";" + //onmessage callback
  ...
  Module(function (Tone) {
    ...
    Tone.Listener.prototype.setPosition = function (x, y, z) {
      if (this._listener.positionX) {
        var now = this.now();
        this._listener.positionX.setTargetAtTime(
          x,
          now,
          this._rampTimeConstant
        );
        this._listener.positionY.setTargetAtTime(
          y,
          now,
          this._rampTimeConstant
        );
        this._listener.positionZ.setTargetAtTime(
          z,
          now,
          this._rampTimeConstant
        );
  ...
  Module(function (Tone) {
    ...
    Tone.BufferSource.prototype.stop = function (time, fadeOutTime) {
      if (this.buffer) {
        ...
        if (
          !this.isNumber(this._source.playbackState) ||
          this._source.playbackState === 2
        ) {
