...
<table id="cust_tab">
	...
	<tr class="form_data">
		...
		<td>			<input type="text" style="width: 400px;" value="" name="url"/>
...
<script$(function() {
	...
	function smTypeChange() {
		...
		if (smT			$('#sm_url_label').html("<?php echo $spTextSMC['Company Id']?>:");
			$('#sm_url_note').show();
		} else {
			$('#sm			$('#sm_url_note').hide();
		}	
	...
	smType	$("#sm_type").on('change', function() {
		smTypeChange();
	});
});</script>
