...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
	...
	<tr class="white_row">		<td class="td_left_col"><?php echo $spTextDir['Website Category']?>:</td>
		<td class="td_right_col">
	...
	<tr class="blue_row">
		<td class="td_lef		<td class="td_right_col">
			...
			<br><?php echo $errMsg['url']?>		</td>
	</tr>
	<tr class="white_row">
		<td class="td_left_col"><?php echo $sp		<td class="td_right_col"><input type="text" id="webtitle" name="title" value="<?php echo stripslashes($websiteInfo['title'])?>" style="width:400px;"><?php echo $errMsg['title']?></td>
	</tr>
	<tr class="blue_row">
		<td class="td_left_col"><?php echo $spTextDir['Submit Description']?>1:</td>
		<td cla			<textarea name="description" id="webdescription"><?php echo stripslashes($websiteInfo['description'])?></textarea><?php echo $errMsg['description']?>
			<p><?php echo $spTextDir['desnote']?></p>
		</td>
	</tr>
	<tr class="white_row">		<td class="td_left_col"><?php echo $spTextDir['Submit Keywords']?>:</td>
	...
	<tr class="blue_row">		<td class="td_left_col"><?php echo $spTextDir['Reciprocal Link']?>:</td>
	...
	<tr class="white_row" style="border-right: none;">
		<td cla		<td class="td_right_col"><b><?php echo $spTextDir['optionalnote']?></b></td>
	</tr>
	<?php for($i=2;$i<=$noTitles;$i++){?>	
		<tr class="blue_row">			<td class="td_left_col"><?php echo $spTextDir['Submit Title']?><?php echo $i?>:</td>
		...
		<tr class="white_row">
			...
			<td class="td_right_col">				<textarea name="description<?php echo $i?>"><?php echo stripslashes($websiteInfo['description'.$i])?></textarea>
			</td>
		</tr>
	<?php }?>			<tr class="blue_row">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="actionSec">
	<tr>
    	<td style="padding-top: 6px;text-align:right;">
    		<a onclick="scriptDoLoad('dire         		<?php echo $spText['button']['Cancel']?>
         	</a>&nbsp;
