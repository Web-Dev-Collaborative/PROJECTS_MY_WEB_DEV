...
<table width="100%" class="search">
	<tr>
		...
		</td>		<th><?php echo $spText['common']['Status']?>: </th>
		<td colspan="2">
			<select name="status" onchange="<?php echo $searchFun?>">
				...
				?>
			</sele			<a href="javascript:void(0);" onclick="<?php echo $searchFun?>" class="actionbut"><?php echo $spText['button']['Show Records']?></a>
		</td>
	</tr>
</table></form>
...
<table 	<tr>
		...
		<th><?php echo $spText['common']['Name']?></th>
		<th><    	<th><?php echo $spText['common']['Link']?></th>
    	<th><?php echo $spText['common']['Website']?></th>
