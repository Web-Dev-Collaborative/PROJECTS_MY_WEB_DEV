...
(function (scope) {
  ...
  var STOP_PROP_FN =
    Event.prototype.stopImmediatePropagation || Event.prototype.stopPropagation;
  ...
  function (scope) {
    ...
    var track = {
      ...
      down: function (inEvent) {
        if (
          inEvent.isPrimary &&
          (inEvent.pointerType === "mouse" ? inEvent.buttons === 1 : true)
        ) {
          var p = {
            downEvent: inEvent,
...
(function (global) {
  ...
  Expression.prototype = {
    getBinding: function (model, filterRegistry, oneTime) {
      if (oneTime) return this.getValue(model, undefined, filterRegistry);
      ...
      function valueFn() {
        ...
        if (self.dynamicDeps) observer.startReset();
        ...
        if (self.dynamicDeps) observer.finishReset();
  ...
  PolymerExpressions.prototype = {
    ...
    prepareBinding: function (pathString, name, node) {
      ...
      if (!isLiteralExpression(pathString) && path.valid) {
        if (path.length == 1) {
          return function (model, node, oneTime) {
            if (oneTime) return path.getValueFrom(model);
...
(function (global) {
  ...
  function newObservedObject() {
    ...
    return {
      ...
      observe: function (obj, arrayObserve) {
        object = obj;
        if (arrayObserve) Array.observe(object, callback);
        else Object.observe(object, callback);
      },
  ...
  function newObservedSet() {
    ...
    var record = {
      ...
      close: function (obs) {
        ...
        if (lastObservedSet === this) lastObservedSet = null;
      },
    };
  ...
  Observer.prototype = {
    ...
    report_: function (changes) {
      try {
        ...
        console.error(
          "Exception caught during observer callback: " + (ex.stack || ex)
        );
      }
    },
  ...
  ObjectObserver.prototype = createObject({
    ...
    connect_: function (callback, target) {
      if (hasObserve) {
        this.directObserver_ = getObservedObject(
          this,
          this.value_,
          this.arrayObserve
        );
    ...
    deliver: function () {
      ...
      if (hasObserve) this.directObserver_.deliver(false);
      else dirtyCheck(this);
    },

    discardChanges: function () {
      if (this.directObserver_) this.directObserver_.deliver(true);
      else this.oldObject_ = this.copyObject(this.value_);
  ...
  function calcSplices(
    ...
    return arraySplice.calcSplices(
      current,
      currentStart,
      currentEnd,
      old,
...
(function (global) {
  ...
  function updateBindings(node, name, binding) {
    ...
    if (!bindings) bindings = node.bindings_ = {};

    if (bindings[name]) binding[name].close();
  ...
  Text.prototype.bind = function (name, value, oneTime) {
    ...
    if (oneTime) return updateText(this, value);
  ...
  Element.prototype.bind = function (name, value, oneTime) {
    ...
    if (oneTime) return updateAttribute(this, name, conditional, value);
  ...
  HTMLInputElement.prototype.bind = function (name, value, oneTime) {
    ...
    if (oneTime) return updateInput(this, name, value, sanitizeFn);
  ...
  HTMLTextAreaElement.prototype.bind = function (name, value, oneTime) {
    ...
    if (oneTime) return updateInput(this, "value", value);
  ...
  HTMLOptionElement.prototype.bind = function (name, value, oneTime) {
    ...
    if (oneTime) return updateOption(this, value);
  ...
  HTMLSelectElement.prototype.bind = function (name, value, oneTime) {
    ...
    if (oneTime) return updateInput(this, name, value);
...
(function (global) {
  ...
  function searchRefId(node, id) {
    ...
    while (!ref) {
      ...
      if (node.protoContent_) ref = node.protoContent_.querySelector(selector);
      else if (node.getElementById) ref = node.getElementById(id);

      if (ref || !node.templateCreator_) break;
  ...
  if (typeof document.contains != "function") {
    Document.prototype.contains = function (node) {
      if (node === this || node.parentNode === this) return true;
  ...
  var allTemplatesSelectors =
    "template, " +
    Object.keys(semanticTemplateElements)
  ...
  function isAttributeTemplate(el) {
    return Boolean(
      semanticTemplateElements[el.tagName] && el.hasAttribute("template")
    );
  }
  ...
  HTMLTemplateElement.decorate = function (el, opt_instanceRef) {
    ...
    var isNativeHTMLTemplate =
      isHTMLTemplate(templateElement) && hasTemplateElement;
  ...
  function fixTemplateElementPrototype(el) {
    if (hasProto) el.__proto__ = HTMLTemplateElement.prototype;
    else mixin(el, HTMLTemplateElement.prototype);
  }
  ...
  mixin(HTMLTemplateElement.prototype, {
    ...
    processBindingDirectives_: function (directives) {
      if (this.iterator_) this.iterator_.closeDeps();
    ...
    createInstance: function (model, bindingDelegate, delegate_) {
      if (bindingDelegate) delegate_ = this.newDelegate_(bindingDelegate);
      else if (!delegate_) delegate_ = this.delegate_;

      if (!this.refContent_) this.refContent_ = this.ref_.content;
      var content = this.refContent_;
      if (content.firstChild === null) return emptyInstance;
      ...
      for (var child = content.firstChild; child; child = child.nextSibling) {
        ...
        var clone = cloneAndBindInstance(
          child,
          instance,
          stagingDocument,
          map.children[i++],
        ...
        if (collectTerminator) instance.terminator_ = clone;
      }
    ...
    refChanged_: function () {
      if (!this.iterator_ || this.refContent_ === this.ref_.content) return;
    ...
    clear: function () {
      ...
      if (this.bindings_ && this.bindings_.ref) this.bindings_.ref.close();
      this.refContent_ = undefined;
      if (!this.iterator_) return;
      this.iterator_.valueChanged();
      this.iterator_.close();
      this.iterator_ = undefined;
    },
    ...
    newDelegate_: function (bindingDelegate) {
      ...
      return {
        ...
        prepareInstancePositionChanged: delegateFn(
    ...
    set bindingDelegate(bindingDelegate) {
      if (this.delegate_) {
        throw Error(
          "Template must be cleared before a new bindingDelegate " +
            "can be assigned"
        );
      }
  ...
  function parseMustaches(s, name, node, prepareBindingFn) {
    ...
    while (lastIndex < length) {
      ...
      var delegateFn =
        prepareBindingFn && prepareBindingFn(pathString, name, node);
    ...
    tokens.isSimplePath =
      tokens.hasOnePath && tokens[0] == "" && tokens[4] == "";
  ...
  function processBinding(name, tokens, node, model) {
    ...
    for (var i = 1; i < tokens.length; i += 4) {
      ...
      if (delegateFn) {
        ...
        if (oneTime) observer.addPath(value);
        else observer.addObserver(value);
        continue;
      }

      var path = tokens[i + 1];
      if (oneTime) observer.addPath(path.getValueFrom(model));
      else observer.addPath(model, path);
    }
  ...
  function processBindings(node, bindings, model, instanceBindings) {
    for (var i = 0; i < bindings.length; i += 2) {
      ...
      if (binding && instanceBindings) instanceBindings.push(binding);
    }

    node.bindFinished();
    if (!bindings.isTemplate) return;

    node.model_ = model;
    var iter = node.processBindingDirectives_(bindings);
    if (instanceBindings && iter) instanceBindings.push(iter);
  }
  ...
  function cloneAndBindInstance(
    ...
    if (bindings.isTemplate) {
      ...
      if (delegate) clone.setDelegate_(delegate);
    }
  ...
  function getContentUid(content) {
    var id = content.id_;
    if (!id) id = content.id_ = contentUidCounter++;
    return id;
  }
  ...
  Object.defineProperty(Node.prototype, "templateInstance", {
    get: function () {
      ...
      return instance
        ? instance
        : this.parentNode
        ? this.parentNode.templateInstance
        : undefined;
    },
  });
  ...
  TemplateIterator.prototype = {
    closeDeps: function () {
      var deps = this.deps;
      if (deps) {
        if (deps.ifOneTime === false) deps.ifValue.close();
        if (deps.oneTime === false) deps.value.close();
      }
    },
    ...
    updateDependencies: function (directives, model) {
      ...
      if (directives.if) {
        ...
        if (!deps.ifOneTime) ifValue = ifValue.open(this.updateIfValue, this);
      }
      ...
      if (!deps.oneTime) value = value.open(this.updateIteratedValue, this);
    ...
    getUpdatedValue: function () {
      ...
      if (!this.deps.oneTime) value = value.discardChanges();
      return value;
    },
    ...
    updateIteratedValue: function (value) {
      if (this.deps.hasIf) {
        ...
        if (!this.deps.ifOneTime) ifValue = ifValue.discardChanges();
        if (!ifValue) {
          this.valueChanged();
          return;
        }
    ...
    updateValue: function (value) {
      if (!this.deps.repeat) value = [value];
      var observe =
        this.deps.repeat && !this.deps.oneTime && Array.isArray(value);
    ...
    valueChanged: function (value, observeValue) {
      ...
      if (value === this.iteratedValue) return;
      ...
      this.handleSplices(
        ArrayObserver.calculateSplices(this.presentValue, this.iteratedValue)
      );
    },

    getLastInstanceNode: function (index) {
      if (index == -1) return this.templateElement_;
      var instance = this.instances[index];
      var terminator = instance.terminator_;
      if (!terminator) return this.getLastInstanceNode(index - 1);

      if (
        terminator.nodeType !== Node.ELEMENT_NODE ||
      ...
      if (!subtemplateIterator) return terminator;
    ...
    handleSplices: function (splices) {
      if (this.closed || !splices.length) return;
      ...
      if (this.instanceModelFn_ === undefined) {
        this.instanceModelFn_ = this.getDelegateFn(
          delegate && delegate.prepareInstanceModel
        );
      }

      if (this.instancePositionChangedFn_ === undefined) {
        this.instancePositionChangedFn_ = this.getDelegateFn(
          delegate && delegate.prepareInstancePositionChanged
        );
      }
      ...
      if (this.instancePositionChangedFn_) this.reportInstancesMoved(splices);
    },

    reportInstanceMoved: function (index) {
      var instance = this.instances[index];
      if (instance === emptyInstance) return;
...
(function (scope) {
  ...
  new (window.MutationObserver || JsMutationObserver)(atEndOfMicrotask).observe(
    twiddle,
    { characterData: true }
  );
...
(function (scope) {
  var urlResolver = {
    ...
    resolveCssText: function (cssText, baseUrl, keepAbsolute) {
      cssText = replaceUrlsInCssText(
        cssText,
        baseUrl,
        keepAbsolute,
        CSS_URL_REGEXP
      );
      return replaceUrlsInCssText(
        cssText,
        baseUrl,
        keepAbsolute,
        CSS_IMPORT_REGEXP
    ...
    resolveElementAttributes: function (node, url) {
      ...
      URL_ATTRS.forEach(function (v) {
        ...
        if (value && value.search(URL_TEMPLATE_SEARCH) < 0) {
          if (v === "style") {
            replacement = replaceUrlsInCssText(
              value,
              url,
              false,
              CSS_URL_REGEXP
  ...
  function makeRelPath(sourceUrl, targetUrl) {
    ...
    var hash =
      targetUrl.href.slice(-1) === URL_HASH ? URL_HASH : targetUrl.hash;
...
(function (scope) {
  ...
  function getPropertyDescriptor(inObject, inName) {
    if (inObject) {
      ...
      return (
        pd || getPropertyDescriptor(Object.getPrototypeOf(inObject), inName)
      );
    }
  }
...
(function (scope) {
  ...
  function createDOM(inTagOrNode, inHTML, inAttrs) {
    var dom =
      typeof inTagOrNode == "string"
        ? document.createElement(inTagOrNode)
        : inTagOrNode.cloneNode(true);
...
(function (scope) {
  ...
  scope.removeEventListener = function (node, eventType, handlerFn, capture) {
    PolymerGestures.removeEventListener(
      wrap(node),
      eventType,
      handlerFn,
      capture
...
(function (scope) {
  ...
  var attributes = {
    ...
    takeAttributes: function () {
      ...
      if (this._publishLC) {
        for (
          var i = 0, a$ = this.attributes, l = a$.length, a;
          (a = a$[i]) && i < l;
          i++
        ) {
      ...
      for (var i in oldValues) {
        ...
        if (method) {
          ...
          if (!called[method]) {
            ...
            if (
              (ov !== undefined && ov !== null) ||
              (nv !== undefined && nv !== null)
            ) {
              called[method] = true;
...
(function (scope) {
  ...
  var mdv = {
    ...
    instanceTemplate: function (template) {
      ...
      var syntax =
        this.syntax || (!template.bindingDelegate && this.element.syntax);
...
(function (scope) {
  ...
  var styles = {
    ...
    installScopeCssText: function (cssText, scope, name) {
      ...
      var style = this.element.cssTextToScopeStyle(
        cssText,
    ...
    styleCacheForScope: function (scope) {
      if (hasShadowDOMPolyfill) {
        ...
        return (
          polyfillScopeStyleCache[scopeName] ||
          (polyfillScopeStyleCache[scopeName] = {})
        );
      } else {
...
(function (scope) {
  ...
  if (WebComponents.consumeDeclarations) {
    WebComponents.consumeDeclarations(function (declarations) {
      if (declarations) {
        for (
          var i = 0, l = declarations.length, d;
          i < l && (d = declarations[i]);
          i++
        ) {
  ...
  var styles = {
    ...
    convertSheetsToStyles: function (root) {
      ...
      for (var i = 0, l = s$.length, s, c; i < l && (s = s$[i]); i++) {
        c = createStyleElement(
          importRuleForSheet(s, this.ownerDocument.baseURI),
          this.ownerDocument
        );
    ...
    copySheetAttributes: function (style, link) {
      for (
        var i = 0, a$ = link.attributes, l = a$.length, a;
        (a = a$[i]) && i < l;
        i++
      ) {
    ...
    cssTextToScopeStyle: function (cssText, scopeDescriptor) {
      if (cssText) {
        ...
        style.setAttribute(
          ...
          this.getAttribute("name") + "-" + scopeDescriptor
        );
        return style;
      }
    },
...
(function (scope) {
  ...
  var events = {
    ...
    addAttributeDelegates: function (delegates) {
      ...
      for (var i = 0, a; (a = this.attributes[i]); i++) {
        ...
        if (this.hasEventPrefix(a.name)) {
          ...
          delegates[this.removeEventPrefix(a.name)] = a.value
            .replace("{{", "")
            .replace("}}", "")
            .trim();
        }
    ...
    prepareEventBinding: function (pathString, name, node) {
      if (!this.hasEventPrefix(name)) return;
        ...
        if (this.propertyNameBlacklist[name]) {
          console.warn(
            'Cannot define property "' +
              ...
              '" for element "' +
              this.name +
              '" because it has the same name as an HTMLElement ' +
    ...
    createPropertyAccessor: function (name, ignoreWrites) {
      ...
      Object.defineProperty(proto, name, {
        get: function () {
          ...
          if (observable) observable.deliver();
  ...
  var queue = {
    ...
    indexOf: function (element) {
      ...
      if (i >= 0 && document.contains(element)) {
        i +=
          HTMLImports.useNative || HTMLImports.ready ? importQueue.length : 1e9;
      }
      return i;
    },
...
(function (scope) {
  ...
  var prototype = extend(Object.create(HTMLElement.prototype), {
    ...
    _register: function () {
      ...
      if (isCustomTag(this.extends) && !isRegistered(this.extends)) {
        console.warn(
          "%s is attempting to extend %s, an unregistered element " +
  ...
  whenReady(function () {
    ...
    document.dispatchEvent(new CustomEvent("polymer-ready", { bubbles: true }));
  });
...
(function (scope) {
  ...
  function _import(urls, callback) {
    if (urls && urls.length) {
      ...
      for (
        var i = 0, l = urls.length, url, link;
        i < l && (url = urls[i]);
        i++
      ) {
